...
```ts
import { Emitter } from '@xinjs/patterns'

const eventEmitter = new Emitter()

eventEmitter.subscribe('event1', (msg) => {
  console.log(`Received:${msg}`)
})

eventEmitter.publish('event1', 'Emitter')

eventEmitter.unsubscribe('event1')

eventEmitter.publish('event1', 'Emitter2')
